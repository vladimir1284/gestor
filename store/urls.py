...
urlpatterns = [
    ...
    path('supplier-list/', SupplierListView.as_view(), name='supplier-cards'),
    path('buyer-list/', BuyerListView.as_view(), name='client-cards'),
    path('user-list/', BuyerListView.as_view(), name='user-cards'),
