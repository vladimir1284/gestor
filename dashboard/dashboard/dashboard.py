...
from dashboard.dashboard.cards.contract_renovations import \
...
from dashboard.dashboard.cards.security_deposit_devolution import \
    SecurityDepositDevPendingCard
