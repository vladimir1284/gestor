...
urlpatterns = [
    ...
    path(
        "create-transaction-new-order/<product_id>",
        transaction.create_transaction_new_order,
        name="create-transaction-new-order",
    ),
    path(
    ...
    path(
        ...
        product.list_deactivated_product,
    ...
    path(
        "select-product/<next>/<order_id>",
        product.select_product,
        name="select-product",
    ),
    path(
        "select-new-product/<next>/<order_id>",
        product.select_new_product,
    ...
    path(
        ...
        name="create-kit-transaction",
    ),
    # --------------------- Kit Services ------------------------
    path(
        "create-kit-service/<kit_id>/<service_id>",
